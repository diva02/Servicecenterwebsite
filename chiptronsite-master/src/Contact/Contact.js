...
systems.</p>
                            ...
                            <div className="mt-7 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">Innovative solutions and effective solutions to your problems</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="w-full 2xl:pl-48 xl:pt-1">
                                    ...
                                    <div className="w-full md:w-10/12 mt-3">
                                        ...
                                        <div className="mt-4 md:mt-8">
                                            ...
                                            <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">business@titankustoms.com</h2>
