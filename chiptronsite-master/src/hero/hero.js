        ...
        <div className="pt-12 bg-white overflow-y-hidden">
            ...
            <dh-component>
                ...
                <div className="w-full px-6">
                    <div className="mt-0 relative rounded-lg bg-indigo-700 container mx-auto flex flex-col items-center pt-10 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
