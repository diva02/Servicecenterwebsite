        ...
        <div className=" pb-72 pt-10 bg-white overflow-y-hidden">
            ...
            <dh-component>
                ...
                <div className="w-full ">
                    <div className="mt-0 relative rounded-lg bg-indigo-700 w-fill flex flex-col items-center pt-0 sm:pt-24 pb-20 sm:pb-24 md:pb-48 lg:pb-56 xl:pb-64">
                        ...
                        <div className="sm:pt-6 w-11/12 sm:w-2/3 mb-5 items-center">
                            <h1 className="text-3xl pt-5  sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center  flex text-white font-bold leading-relaxed ">We're here for you whenever you need us</h1>
                        </div>
                    ...
                    <div className="container mx-auto flex justify-center md:-mt-56 mt-0 sm:-mt-36">
                        <div className="relative sm:w-4/5 w-11/12 md:w-1/2">
