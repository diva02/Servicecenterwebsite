...
export default function Caro() {
  return (
    ...
    <ImageSlider  effectDelay={200} autoPlayDelay={2500}>
      <Slide>
        <img alt="img2" className="object-center" src="http://www.chiptronix.in/img/desktop.jpg" />
      </Slide>
      <Slide>
        <img alt="img2"  className="sm:w-auto sm:h-auto sm:object-center" src="http://www.chiptronix.in/img/chipp.jpg" />
      </Slide>
      <Slide>
        <img alt="img1"  className="object-center " src="http://www.chiptronix.in/img/eee.png" />
      </Slide>
      <Slide>
      ...
      <Slide>
        <img alt="img1" className="object-center" src="http://www.chiptronix.in/img/topservice.png" />
      </Slide>
    </ImageSlider>
