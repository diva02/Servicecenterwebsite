...
<div className="bg-gray-200 h-full w-full">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                            ...
                            <div className=" w-1/2    xl:flex-1">
                                <div className="flex sm:justify-end items-center">
                                    <img className=" xl:h-13 xl:w-full sm:w-full" src="http://www.chiptronix.in/img/logo%20(1).png " alt="Chiptronix"></img>
                                </div>
                            </div>
                            <div className="flex">
                                            ...
                                            <a href="/spares" className="cursor-pointer">
                                                <li className="text-gray-800 pt-8">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p  className="text-indigo-700 xl:text-base md:text-2xl text-base ml-3">Laptop Spares/Accessories</p>
                                                    </div>
                                                </li>
                                            </a>
